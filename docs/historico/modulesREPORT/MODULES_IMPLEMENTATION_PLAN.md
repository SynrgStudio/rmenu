...
- Mini docs de contrato en `modulesREPORT`.
...
8. docs completas en `modulesREPORT/*`.
...
1. `modulesREPORT/MODULES_IMPLEMENTATION_PLAN.md`
2. `modulesREPORT/extensions_implementation_plan.md`
3. `modulesREPORT/DECISIONS.md`
...
- `modulesREPORT/MODULES_API_SPEC_V1.md`
- `modulesREPORT/MANIFEST_SPEC_V1.md`
- `modulesREPORT/CTX_ACTIONS_SPEC_V1.md`
- `modulesREPORT/PROVIDER_EXECUTION_POLICY.md`
- `modulesREPORT/ERROR_ISOLATION_POLICY.md`
